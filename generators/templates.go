...
var TEMPLATE_BASIC_ACCESSORS = `// Code generated by github.com/caerbannogwhite/enchanter/generators. DO NOT EDIT.
...
func (s {{.SeriesName}}) GetContext() *enchanter.Context {
	return s.Ctx_
}
...
func (s {{.SeriesName}}) IsSorted() enchanter.SeriesSortOrder {
	return s.Sorted_
}
